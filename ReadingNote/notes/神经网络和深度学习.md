...
>%%
>```annotation-json
>{"text":"反向传播假设1/2","target":[{"source":"vault:/assets/neural networks and deep learning.pdf","selector":[{"type":"TextPositionSelector","start":50136,"end":50185},{"type":"TextQuoteSelector","exact":"第一个假设就是代价函数可以被写成一个在每个训练样本x 上的代价函数Cx的均值C = 1n∑xCx。","prefix":"为了应用反向传播，我们需要对代价函数C 做出什么样的前提假设呢？","suffix":"这是关于二次代价函数的例子，其中对每个独立的训练样本其代价是Cx"}]}],"created":"2023-01-31T03:24:27.440Z","updated":"2023-01-31T03:24:27.440Z","document":{"title":"neural networks and deep learning.pdf","link":[{"href":"urn:x-pdf:c27b805d8ea7529f8de84e4585f6d06b"},{"href":"vault:/assets/neural networks and deep learning.pdf"}],"documentFingerprint":"c27b805d8ea7529f8de84e4585f6d06b"},"uri":"vault:/assets/neural networks and deep learning.pdf"}
>```
>%%
>*%%PREFIX%%为了应用反向传播，我们需要对代价函数C 做出什么样的前提假设呢？%%HIGHLIGHT%% ==第一个假设就是代价函数可以被写成一个在每个训练样本x 上的代价函数Cx的均值C = 1n∑xCx。== %%POSTFIX%%这是关于二次代价函数的例子，其中对每个独立的训练样本其代价是Cx*
>%%LINK%%[[#^dsze2i83dh7|show annotation]]
...
>%%
>```annotation-json
>{"text":"反向传播假设2/2","target":[{"source":"vault:/assets/neural networks and deep learning.pdf","selector":[{"type":"TextPositionSelector","start":50417,"end":50439},{"type":"TextQuoteSelector","exact":"第二个假设就是代价可以写成神经网络输出的函数","prefix":"看做C。最终我们会把下标加上，现在为了简化表示其实没有这个必要。","suffix":"：1其实，这就是让我们使用之前的矩阵下标wljk表示的初因。如果"}]}],"created":"2023-01-31T03:24:51.998Z","updated":"2023-01-31T03:24:51.998Z","document":{"title":"neural networks and deep learning.pdf","link":[{"href":"urn:x-pdf:c27b805d8ea7529f8de84e4585f6d06b"},{"href":"vault:/assets/neural networks and deep learning.pdf"}],"documentFingerprint":"c27b805d8ea7529f8de84e4585f6d06b"},"uri":"vault:/assets/neural networks and deep learning.pdf"}
>```
>%%
>*%%PREFIX%%看做C。最终我们会把下标加上，现在为了简化表示其实没有这个必要。%%HIGHLIGHT%% ==第二个假设就是代价可以写成神经网络输出的函数== %%POSTFIX%%：1其实，这就是让我们使用之前的矩阵下标wljk表示的初因。如果*
>%%LINK%%[[#^ib6eo9lth3|show annotation]]
...
>%%
>```annotation-json
>{"created":"2023-02-01T01:51:26.587Z","text":"导致神经网络普遍性定理无法做到\"完美\"的问题点\n\n当调整权重w和偏执b来改变激活函数的表现, 当激活函数趋近于越阶函数时存在无法完美拟合的\"拐点\"\n\n这个\"拐点\"区间就是故障窗口，当输入给神经元的计算值处于故障窗口中时，神经元的计算结果会于实际值产生偏差，因此神经网络无法做到\"完美\"的普遍性","updated":"2023-02-01T01:51:26.587Z","document":{"title":"neural networks and deep learning.pdf","link":[{"href":"urn:x-pdf:c27b805d8ea7529f8de84e4585f6d06b"},{"href":"vault:/assets/neural networks and deep learning.pdf"}],"documentFingerprint":"c27b805d8ea7529f8de84e4585f6d06b"},"uri":"vault:/assets/neural networks and deep learning.pdf","target":[{"source":"vault:/assets/neural networks and deep learning.pdf","selector":[{"type":"TextPositionSelector","start":151256,"end":151260},{"type":"TextQuoteSelector","exact":"故障窗口","prefix":"1354.5. 修补阶跃函数0 11x顶部隐藏神经元的输出在这些","suffix":"中我给出的普遍性的解释会失败。现在，它不是一个很严重的故障。通过"}]}]}
>```
>%%
>*%%PREFIX%%1354.5. 修补阶跃函数0 11x顶部隐藏神经元的输出在这些%%HIGHLIGHT%% ==故障窗口== %%POSTFIX%%中我给出的普遍性的解释会失败。现在，它不是一个很严重的故障。通过*
>%%LINK%%[[#^p61s9hohvhe|show annotation]]
>%%COMMENT%%
>导致神经网络普遍性定理无法做到"完美"的问题点
>
>当调整权重w和偏执b来改变激活函数的表现, 当激活函数趋近于越阶函数时存在无法完美拟合的"拐点"
>
>这个"拐点"区间就是故障窗口，当输入给神经元的计算值处于故障窗口中时，神经元的计算结果会于实际值产生偏差，因此神经网络无法做到"完美"的普遍性
>%%TAGS%%
>
^p61s9hohvhe
...
>%%
>```annotation-json
>{"created":"2023-02-03T08:35:37.041Z","updated":"2023-02-03T08:35:37.041Z","document":{"title":"neural networks and deep learning.pdf","link":[{"href":"urn:x-pdf:c27b805d8ea7529f8de84e4585f6d06b"},{"href":"vault:/assets/neural networks and deep learning.pdf"}],"documentFingerprint":"c27b805d8ea7529f8de84e4585f6d06b"},"uri":"vault:/assets/neural networks and deep learning.pdf","target":[{"source":"vault:/assets/neural networks and deep learning.pdf","selector":[{"type":"TextPositionSelector","start":15529,"end":15538},{"type":"TextQuoteSelector","exact":"最左边的称为输入层","prefix":"有帮助的。假设我们有这样的网络：output前面提过，这个网络中","suffix":"，其中的神经元称为输入神经元。最右边的，即输出层包含有输出神经元"}]}]}
>```
>%%
>*%%PREFIX%%有帮助的。假设我们有这样的网络：output前面提过，这个网络中%%HIGHLIGHT%% ==最左边的称为输入层== %%POSTFIX%%，其中的神经元称为输入神经元。最右边的，即输出层包含有输出神经元*
>%%LINK%%[[#^o7xvh20d1ea|show annotation]]
>%%COMMENT%%
>
>%%TAGS%%
>
...
>%%
>```annotation-json
>{"created":"2023-02-03T08:35:44.099Z","updated":"2023-02-03T08:35:44.099Z","document":{"title":"neural networks and deep learning.pdf","link":[{"href":"urn:x-pdf:c27b805d8ea7529f8de84e4585f6d06b"},{"href":"vault:/assets/neural networks and deep learning.pdf"}],"documentFingerprint":"c27b805d8ea7529f8de84e4585f6d06b"},"uri":"vault:/assets/neural networks and deep learning.pdf","target":[{"source":"vault:/assets/neural networks and deep learning.pdf","selector":[{"type":"TextPositionSelector","start":15553,"end":15562},{"type":"TextQuoteSelector","exact":"最右边的，即输出层","prefix":"提过，这个网络中最左边的称为输入层，其中的神经元称为输入神经元。","suffix":"包含有输出神经元，在本例中，输出层只有一个神经元。中间层，既然这"}]}]}
>```
>%%
>*%%PREFIX%%提过，这个网络中最左边的称为输入层，其中的神经元称为输入神经元。%%HIGHLIGHT%% ==最右边的，即输出层== %%POSTFIX%%包含有输出神经元，在本例中，输出层只有一个神经元。中间层，既然这*
>%%LINK%%[[#^wd14td0vrtc|show annotation]]
>%%COMMENT%%
>
>%%TAGS%%
>
...
>%%
>```annotation-json
>{"created":"2023-02-03T08:36:02.762Z","updated":"2023-02-03T08:36:02.762Z","document":{"title":"neural networks and deep learning.pdf","link":[{"href":"urn:x-pdf:c27b805d8ea7529f8de84e4585f6d06b"},{"href":"vault:/assets/neural networks and deep learning.pdf"}],"documentFingerprint":"c27b805d8ea7529f8de84e4585f6d06b"},"uri":"vault:/assets/neural networks and deep learning.pdf","target":[{"source":"vault:/assets/neural networks and deep learning.pdf","selector":[{"type":"TextPositionSelector","start":15600,"end":15618},{"type":"TextQuoteSelector","exact":"既不是输入也不是输出，则被称为隐藏层","prefix":"经元，在本例中，输出层只有一个神经元。中间层，既然这层中的神经元","suffix":"。“隐藏”这一术语也许听上去有些神秘——我第一次听到这个词，以为"}]}]}
>```
>%%
>*%%PREFIX%%经元，在本例中，输出层只有一个神经元。中间层，既然这层中的神经元%%HIGHLIGHT%% ==既不是输入也不是输出，则被称为隐藏层== %%POSTFIX%%。“隐藏”这一术语也许听上去有些神秘——我第一次听到这个词，以为*
>%%LINK%%[[#^smr6kt1mq6i|show annotation]]
>%%COMMENT%%
>
>%%TAGS%%
>
...
>%%
>```annotation-json
>{"created":"2023-02-05T06:01:02.212Z","updated":"2023-02-05T06:01:02.212Z","document":{"title":"neural networks and deep learning.pdf","link":[{"href":"urn:x-pdf:c27b805d8ea7529f8de84e4585f6d06b"},{"href":"vault:/assets/neural networks and deep learning.pdf"}],"documentFingerprint":"c27b805d8ea7529f8de84e4585f6d06b"},"uri":"vault:/assets/neural networks and deep learning.pdf","target":[{"source":"vault:/assets/neural networks and deep learning.pdf","selector":[{"type":"TextPositionSelector","start":24240,"end":24259},{"type":"TextQuoteSelector","exact":"在C 下降最快的方向上做微小变化的方法","prefix":"⻓限制∥∆v∥ = ε 所决定的。因此，梯度下降法可以被视为一种","suffix":"。练习• 证明上一段落的推断。提示：可以利用柯西-施瓦茨不等式。"}]}]}
>```
>%%
>*%%PREFIX%%⻓限制∥∆v∥ = ε 所决定的。因此，梯度下降法可以被视为一种%%HIGHLIGHT%% ==在C 下降最快的方向上做微小变化的方法== %%POSTFIX%%。练习• 证明上一段落的推断。提示：可以利用柯西-施瓦茨不等式。*
>%%LINK%%[[#^jiw526vuno|show annotation]]
>%%COMMENT%%
>
>%%TAGS%%
>
...
>%%
>```annotation-json
>{"created":"2023-02-06T01:22:05.574Z","text":"Sigmoid 激活函数的数学表达","updated":"2023-02-06T01:22:05.574Z","document":{"title":"neural networks and deep learning.pdf","link":[{"href":"urn:x-pdf:c27b805d8ea7529f8de84e4585f6d06b"},{"href":"vault:/assets/neural networks and deep learning.pdf"}],"documentFingerprint":"c27b805d8ea7529f8de84e4585f6d06b"},"uri":"vault:/assets/neural networks and deep learning.pdf","target":[{"source":"vault:/assets/neural networks and deep learning.pdf","selector":[{"type":"TextPositionSelector","start":13293,"end":13308},{"type":"TextQuoteSelector","exact":"σ(z) ≡ 11 + e−z","prefix":"现在是σ(w ·x + b)，这里σ 被称为S型函数1，定义为：","suffix":"(3)把它们放在一起来更清楚地说明，一个具有输入x1, x2, "}]}]}
>```
>%%
>*%%PREFIX%%现在是σ(w ·x + b)，这里σ 被称为S型函数1，定义为：%%HIGHLIGHT%% ==σ(z) ≡ 11 + e−z== %%POSTFIX%%(3)把它们放在一起来更清楚地说明，一个具有输入x1, x2,*
>%%LINK%%[[#^35biedaae91|show annotation]]
>%%COMMENT%%
>Sigmoid 激活函数的数学表达
>%%TAGS%%
>
...
>%%
>```annotation-json
>{"created":"2023-02-06T01:26:07.731Z","text":"深度神经网络的定义","updated":"2023-02-06T01:26:07.731Z","document":{"title":"neural networks and deep learning.pdf","link":[{"href":"urn:x-pdf:c27b805d8ea7529f8de84e4585f6d06b"},{"href":"vault:/assets/neural networks and deep learning.pdf"}],"documentFingerprint":"c27b805d8ea7529f8de84e4585f6d06b"},"uri":"vault:/assets/neural networks and deep learning.pdf","target":[{"source":"vault:/assets/neural networks and deep learning.pdf","selector":[{"type":"TextPositionSelector","start":46914,"end":46946},{"type":"TextQuoteSelector","exact":"包含这种多层结构——两层或更多隐藏层——的网络被称为深度神经网络","prefix":"确的问题，在后面的网络层，它建立了一个更加复杂和抽象的层级结构。","suffix":"。321.7. 迈向深度学习当然，我没有提到如何去递归地分解成子"}]}]}
>```
>%%
>*%%PREFIX%%确的问题，在后面的网络层，它建立了一个更加复杂和抽象的层级结构。%%HIGHLIGHT%% ==包含这种多层结构——两层或更多隐藏层——的网络被称为深度神经网络== %%POSTFIX%%。321.7. 迈向深度学习当然，我没有提到如何去递归地分解成子*
>%%LINK%%[[#^7ehmosngoig|show annotation]]
>%%COMMENT%%
>深度神经网络的定义
>%%TAGS%%
>#名词解释
...
>%%
>```annotation-json
>{"created":"2023-03-28T05:45:46.183Z","updated":"2023-03-28T05:45:46.183Z","document":{"title":"neural networks and deep learning.pdf","link":[{"href":"urn:x-pdf:c27b805d8ea7529f8de84e4585f6d06b"},{"href":"vault:/assets/neural networks and deep learning.pdf"}],"documentFingerprint":"c27b805d8ea7529f8de84e4585f6d06b"},"uri":"vault:/assets/neural networks and deep learning.pdf","target":[{"source":"vault:/assets/neural networks and deep learning.pdf","selector":[{"type":"TextPositionSelector","start":48501,"end":48553},{"type":"TextQuoteSelector","exact":"wljk是从 (l−1)th 层的第 kth 个神经元到 lth 层的第 jth 个神经元的连接上的权重","prefix":"快速计算输出的方法layer 1 layer 2 layer 3","suffix":"w324这样的表示粗看比较奇怪，需要花一点时间消化。但是，后面你"}]}]}
>```
>%%
>*%%PREFIX%%快速计算输出的方法layer 1 layer 2 layer 3%%HIGHLIGHT%% ==wljk是从 (l−1)th 层的第 kth 个神经元到 lth 层的第 jth 个神经元的连接上的权重== %%POSTFIX%%w324这样的表示粗看比较奇怪，需要花一点时间消化。但是，后面你*
>%%LINK%%[[#^5puatw4ad3l|show annotation]]
>%%COMMENT%%
>
>%%TAGS%%
>
